  ...
  return (
    <section id="contact" className="py-12 md:py-16 bg-white px-3 sm:px-6 md:px-10 text-gray-900 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {/* Reveal button - shown until the user chooses to open the terminal */}
        {!showTerminal && (
          <div className="flex justify-center py-10 md:py-14">
            <button
              onClick={() => setShowTerminal(true)}
              className="inline-flex items-center gap-2 bg-navy-600 hover:bg-navy-700 text-white font-semibold text-sm sm:text-base px-6 py-3 rounded-lg shadow-lg transition-colors"
            >
